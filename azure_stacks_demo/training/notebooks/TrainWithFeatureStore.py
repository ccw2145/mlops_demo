...
# ``azure_stacks_demo/assets/model-workflow-asset.yml``
#
# Parameters:
...
dbutils.widgets.text(
    "experiment_name",
    f"/dev-azure_stacks_demo-experiment",
    label="MLflow experiment name",
)
# Unity Catalog registered model name to use for the trained mode.
dbutils.widgets.text(
    "model_name", "dev.azure_stacks_demo.azure_stacks_demo-model", label="Full (Three-Level) Model Name"
)

# Pickup features table name
dbutils.widgets.text(
    "pickup_features_table",
    "dev.azure_stacks_demo.trip_pickup_features",
...
dbutils.widgets.text(
    ...
    "dev.azure_stacks_demo.trip_dropoff_features",
