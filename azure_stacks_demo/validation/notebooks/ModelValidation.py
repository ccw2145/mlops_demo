...
#
# It runs as part of CD and by an automated model training job -> validation -> deployment job defined under ``azure_stacks_demo/assets/model-workflow-asset.yml``
#
#
# Parameters:
#
...
# * custom_metrics_loader_function          - Specifies the name of the function in azure_stacks_demo/validation/validation.py that returns custom metrics.
# * validation_thresholds_loader_function   - Specifies the name of the function in azure_stacks_demo/validation/validation.py that returns model validation thresholds.
#
...
dbutils.widgets.text(
    "experiment_name",
    "/dev-azure_stacks_demo-experiment",
    "Experiment Name",
)
...
dbutils.widgets.text("model_name", "dev.azure_stacks_demo.azure_stacks_demo-model", "Full (Three-Level) Model Name")
