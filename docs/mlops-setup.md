...
[ML Config](../azure_stacks_demo/assets/README.md)  guides to make changes to ML code or deployed jobs.
...
```
git add README.md docs .gitignore azure_stacks_demo/assets/README.md
...
If you want to use different catalog names, please update the targets declared in the [azure_stacks_demo/databricks.yml](../azure_stacks_demo/databricks.yml)
and [azure_stacks_demo/assets/ml-artifacts-asset.yml](../azure_stacks_demo/assets/ml-artifacts-asset.yml)
 files. 
...
Follow the instructions in [azure_stacks_demo/assets/README.md](../azure_stacks_demo/assets/README.md) to deploy ML assets
and production jobs.
...
[ML pull request guide](ml-pull-request.md) and [ML asset config guide](../azure_stacks_demo/assets/README.md)  to propose, test, and deploy
