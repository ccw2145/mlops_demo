...
Opening a pull request will trigger a[workflow](../.github/workflows/azure_stacks_demo-run-tests-fs.yml) 
...
* [Staging model in UC](https://adb-984752964297111.11.azuredatabricks.net/explore/data/models/staging/azure_stacks_demo/azure_stacks_demo-model)
* [Prod model in UC](https://adb-984752964297111.11.azuredatabricks.net/explore/data/models/prod/azure_stacks_demo/azure_stacks_demo-model)
. 
